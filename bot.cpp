...
// Google Vision API endpoint and credentials
const char* apiUrl = "vision.googleapis.com";
...
void rotate(){
  for(int angular = 0; angular <= 180; angular++) {
    ...
    for(int angular = 180; angular >= 0; angular--) {
        servo1.write(angular);
        delay(20);
    }
}
...
String sendPhotoTelegram() {
  ...
  String response = performLabelDetection(fb, fb->len);
